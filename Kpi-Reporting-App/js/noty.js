kpiReporting.noty = (function () {
    return {
        ...
        success: function (text) {
            $('.notyContainer').noty({text: text, timeout: 4000, type: 'success', maxVisible: 10, layout: 'top'});
        },
        warn: function (text) {
            $('.notyContainer').noty({text: text, timeout: 4000, type: 'warning', maxVisible: 10, layout: 'top'});
        },
